...
(function(theme, $) {
	...
	var Skeleton = {
		...
		buildSidebarLeft: function() {
			...
			if (this.sidebars.left.$nano.hasOwnProperty('nanoScroller')) {
		...
		buildSidebarRight: function() {
			...
			if ( this.customScroll ) {
				...
				if (this.sidebars.right.$nano.hasOwnProperty('nanoScroller')) {
		...
		buildContentMenu: function() {
			...
			if (this.sidebars.menu.$nano.hasOwnProperty('nanoScroller')) {
